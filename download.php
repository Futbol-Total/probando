...
<head>
	...
	<link rel="shortcut icon" href="https://allsportsapi.com/images/badge.ico" type="image/x-icon" />
	<link rel="apple-touch-icon" href="https://allsportsapi.com/images/badge.ico">
...
<div id="content">
			...
			<div class="toggle-forms">
				<div class="row justify-content-end">
					<div class="col-md-2 my-2 my-md-0">
						<a class="btn btn-dark w-100" href="https://allsportsapi.com/football-soccer-widgets" role="button">More Widgets</a>
					</div>
					<div class="col-md-4 my-2 my-md-0">
						<a class="btn btn-dark w-100" href="https://allsportsapi.com/" role="button">Back to allsportsapi.com</a>
					</div>
				</div> 
				<div class="row align-items-end">
					...
					<div class="col-md-1 my-2 my-md-0">
						<a class="btn btn-dark w-100" href="https://allsportsapi.com/football-soccer-widgets" role="button">Back</a>
					</div>
				</div>
	...
	<iframe width="100%" height="100%" frameborder="0" src="https://allsportsapi.com/widgets/football-soccer/full/index.html" />
</div>
<iframe src=""></iframe>
